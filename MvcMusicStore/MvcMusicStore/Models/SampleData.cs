...
{
    public class SampleData : DropCreateDatabaseIfModelChanges<MvcMusicStoreEntities>
    {
        protected override void Seed(MvcMusicStoreEntities context)
        {
            ...
            var artists = new List<Artist>
            {
                ...
                new Artist { Name = "Various Artist" },
            ...
            new List<Album>
            {
                ...
                new Album { Title = "Axé Bahia 2001", Genre = genres.Single(g => g.Name == "Pop"), Price = 8.99M, Artist = artists.Single(a => a.Name == "Various Artist"), AlbumArtUrl = "/Content/Images/placeholder.gif" },
                new Album { Title = "Sambas De Enredo 2001", Genre = genres.Single(g => g.Name == "Latin"), Price = 8.99M, Artist = artists.Single(a => a.Name == "Various Artist"), AlbumArtUrl = "/Content/Images/placeholder.gif" },
                new Album { Title = "Vozes do MPB", Genre = genres.Single(g => g.Name == "Latin"), Price = 8.99M, Artist = artists.Single(a => a.Name == "Various Artist"), AlbumArtUrl = "/Content/Images/placeholder.gif" },
